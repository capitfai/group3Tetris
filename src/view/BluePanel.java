...
public class BluePanel extends JPanel implements PropertyChangeListener
{
    ...
    private void setUpPanel()
     ...
     /**
      * This method initializes the information
      * necessary to Display to user: their Score, lines cleared, level,
      *  lines until next level, and the speed of the timer.
      */
     ...
     /**
      * This method sets up the Font for the Display Panel.
      */
